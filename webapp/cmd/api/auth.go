...
// you can verify the token generated at https://jwt.io/

// this const is a var because as a var it can be changed before running a test.
...
func (app *application) generateTokenPair(user *data.User) (TokenPairs, error) {
	...
	// a warning about refresh token that ex. when a user is deleted or blocked from DB, he still get access with the token
